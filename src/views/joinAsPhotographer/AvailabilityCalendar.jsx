    ...
    return (
        <div style={overlayStyle(isNarrow)} onClick={onClose}>
            <div style={modalStyle(isNarrow)} onClick={(e) => e.stopPropagation()}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: isNarrow ? '10px' : '14px', marginTop: '10px' }}>
                    <div>
...
/* ─── Calendar (standalone — no layout wrapper) ───────────────────────────── */
                                            ...
                                            {dayBlocks.slice(0, 4).map((b, idx) => {
                                                ...
                                                return (
                                                    <span
                                                        key={idx}
                                                        title={meta.label}
                                                        style={{ width: '6px', height: '6px', borderRadius: '50%', background: meta.color, display: 'inline-block' }}
                                                    />
                                                );
                                            })}
                                        </div>
