...
const PreLaunchPhoto = () => {
  ...
  const validate = () => {
    ...
    if (!form.mobile_number.trim()) {
      next.mobile_number = 'Mobile / WhatsApp number is required'
    ...
    if (!form.photography_type.length) {
      next.photography_type =
        'Please select at least one photography type'
    }

    if (!form.skills.length) {
      next.skills = 'Please select at least one skill'
    }
    ...
    if (
      form.portfolio_link.trim() &&
      !/^https?:\/\/\S+\.\S+/.test(form.portfolio_link.trim())
    ) {
      next.portfolio_link =
      ...
      <div className="w-full max-w-xl mx-auto py-8 px-4">
        ...
        <div className="views-card" style={{ marginTop: 0 }}>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2
                ...
                style={{ margin: 0 }}
              >
                Join as <span className="text-[#E8A317]">Photographer</span>
              </h2>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            >
              <label style={{ display: 'block', marginBottom: 8 }}>
                City <sup style={{ color: '#ef4444' }}>*</sup>
              </label>
            ...
            >
              ...
              <Select
                ...
                onChange={(selected) => {
                  ...
                  setForm((prev) => ({
                    ...prev,
                    photography_type: vals
                  }))

                  if (errors.photography_type) {
                    setErrors((prev) => ({
                      ...prev,
                      photography_type: undefined
                    }))
                  }
                }}
                ...
                styles={{
                  control: (base, state) => ({
                    ...
                    minHeight: 46,
                    borderRadius: 8,
                    borderColor: errors.photography_type
                      ? '#ef4444'
                      : state.isFocused
                        ? '#f5a623'
                        : '#d1d5db',
            ...
            >
              <label style={{ display: 'block', marginBottom: 8 }}>
                Experience <sup style={{ color: '#ef4444' }}>*</sup>
              </label>
            ...
            >
              ...
              <p
                className="su-field-hint"
                style={{ marginTop: 6 }}
              >
                Add your portfolio website or Instagram profile link
              </p>
