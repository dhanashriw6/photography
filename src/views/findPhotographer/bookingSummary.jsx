            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <Card title="Photographer Information">
                            {/* Avatar + role */}
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                                ...
                                <span style={{ fontSize: '13px', fontWeight: 600, color: '#555' }}>Photographer</span>
                            </div>
                            <DetailPair label="Name" value="John Doe" />
                            <DetailPair label="Gender" value="Male" />
                            <DetailPair label="Email" value="loremipsum@gmail.com" />
                            <DetailPair label="Contact" value="91+ 1234567890" />
                        </Card>
