...
import { FiUser, FiCalendar, FiLock, FiChevronRight, FiHome } from 'react-icons/fi';
...
const MENU = [
    ...
    { key: 'bookings',  label: 'My Bookings',             icon: <FiCalendar size={17} /> },
        ...
        <ViewsLayout>
            <div style={{ width: '100%', margin: '0 auto', padding: '0 40px 60px', fontFamily: 'inherit' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 0 24px', fontSize: '13px', color: '#888' }}>
                    <button onClick={() => navigate('/')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#888', fontFamily: 'inherit', fontSize: '13px', padding: 0, display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <FiHome size={13} /> Home
                    </button>
