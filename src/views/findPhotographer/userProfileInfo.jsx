...
/* ─── Main Component ─────────────────────────────────────────────────────── */
const UserProfileInfo = ({ onSave, onCancel }) => {
    ...
    const [form, setForm] = useState({
        ...
        experience: '', gender: '', altPhone: '', altPhoneCode: '',
    });
    ...
    const handleSave = async () => {
        ...
        const profilePayload = {
            ...
            ...(form.altPhone && { alt_phone_no: form.altPhone }),
            ...(form.altPhoneCode && { alt_phone_code: form.altPhoneCode }),
        };
            ...
            try {
                ...
                if (user) {
                    setForm(f => ({
                        ...
                        gender: user.gender || '',
                        altPhone: user.alt_phone_no || '',
                        altPhoneCountry: user.alt_phone_code|| '',
                    }));
           ...
           <div className="profile-grid">
                ...
                <div className="su-field">
                    ...
                    <div className="su-phone-row">
                        ...
                        <input className="su-number" type="tel" value={form.altPhone} onChange={set('altPhone')} placeholder="00000 00000" />
                    </div>
                    <p className="su-field-hint">Enter a valid phone number to receive OTPs</p>
                </div>
